...
func _on_materials_crafting_item_setted(crafting_item: Dictionary):
	...
	if Autoload.machine_inventory.result_item.slot1:
		result = Autoload.machine_inventory.result_item.slot1
...
func _on_btn_craft_pressed():
	if !is_panel_in_craft:
		...
		Autoload.machine_inventory.set_waiting_time_slot1()
		set_timer(Autoload.machine_inventory.waiting_time.slot1)
		set_progressbar(Autoload.machine_inventory.waiting_time.slot1)
		...
		reset_base()
		Autoload.machine_inventory.reset_slot1() 
...
func set_timer(wait_time):
	if wait_time >= 0:
		...
		if Autoload.machine_inventory:
			Autoload.machine_inventory.set_waiting_time_slot1(wait_time)
	if wait_time == 0:
...
func init_crafting_base():
	print(Autoload.machine_inventory.queue_item.slot1)
	if Autoload.machine_inventory.queue_item.slot1:
		item = Autoload.machine_inventory.queue_item.slot1
		$Materials.set_item(item)
		result = Autoload.machine_inventory.result_item.slot1
		$Results.set_item(result)
		$BtnCraft.show()
		waiting_time = Autoload.machine_inventory.waiting_time.slot1
