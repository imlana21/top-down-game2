...
func _on_materials_crafting_item_setted(crafting_item: Dictionary):
	Autoload.machine_inventory.set_item_slot3(crafting_item)
	if Autoload.machine_inventory.result_item.slot3:
		result = Autoload.machine_inventory.result_item.slot3
...
func _on_btn_craft_pressed():
	if !is_panel_in_craft:
		...
		Autoload.machine_inventory.set_waiting_time_slot3()
		set_timer(Autoload.machine_inventory.waiting_time.slot3)
		set_progressbar(Autoload.machine_inventory.waiting_time.slot3)
		...
		reset_base()
		Autoload.machine_inventory.reset_slot3()
...
func set_timer(wait_time):
	if wait_time >= 0:
		...
		if Autoload.machine_inventory:
			Autoload.machine_inventory.set_waiting_time_slot3(wait_time)
	if wait_time == 0:
...
func init_crafting_base():
	if Autoload.machine_inventory.queue_item.slot3:
		item = Autoload.machine_inventory.queue_item.slot3
		$Materials.set_item(item)
		result = Autoload.machine_inventory.result_item.slot3
		$Results.set_item(result)
		$BtnCraft.show()
		waiting_time = Autoload.machine_inventory.waiting_time.slot3
